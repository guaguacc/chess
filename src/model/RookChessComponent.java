...
public class RookChessComponent extends ChessComponent {
    ...
    public void loadResource() throws IOException {
        if (ROOK_WHITE == null) {
            ROOK_WHITE = ImageIO.read(ChessComponent.class.getResourceAsStream("rook-white.png"));
        }

        if (ROOK_BLACK == null) {
            ROOK_BLACK = ImageIO.read(ChessComponent.class.getResourceAsStream("rook-black.png"));
        }
    }
